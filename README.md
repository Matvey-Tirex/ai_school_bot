...
- В программе применяется ограничение по запросам на 1 пользователя, не более 5. Но вы можете снять это ограничение в фаиле с вашим айди в /json/users(сгенериреутся при первой отправке изображения боту) - выставить роль admin
- Требуемые пакеты для запуска:
  - python3-pip
